...
{
    [Activity(Label = "Visit Sen Restaurant", Icon = "@drawable/smallicon")]
    public class SenMapActivity: Activity
    {
        private Button externalMapButton;
        private FrameLayout mapFrameLayout;
        private MapFragment mapFragment;
        private GoogleMap googleMap;
        private LatLng senLocation;

        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);

            senLocation = new LatLng(50.846704, 4.352446);

            SetContentView(Resource.Layout.SenMapView);
        ...
        {
            Android.Net.Uri senLocationUri = Android.Net.Uri.Parse("geo:50.846704,4.352446");
            Intent mapIntent = new Intent(Intent.ActionView, senLocationUri);
        ...
        private void UpdateMapView()
        {
            ...
            mapReadyCallback.MapReady += (sender, args) =>
            {
                ...
                if (googleMap != null)
                {
                    ...
                    markerOptions.SetPosition(senLocation);
                    markerOptions.SetTitle("Sen Restaurant");
                    googleMap.AddMarker(markerOptions);

                    CameraUpdate cameraUpdate = CameraUpdateFactory.NewLatLngZoom(senLocation, 15);
